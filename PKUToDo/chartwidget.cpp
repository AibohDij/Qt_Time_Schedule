...
void TasksBarChart::setupChart()
{
    ...
    m_chart->setAnimationOptions(QChart::SeriesAnimations);//加入绘制图表的动画
...
void TasksPieChart::setupChart(const QString &title)
{
    ...
    connect(m_series, SIGNAL(clicked(QPieSlice*)), this, SLOT(onPieSeriesClicked(QPieSlice*)));
...
void TasksPieChart::onPieSeriesClicked(QPieSlice* slice)
{
    ...
    : QWidget(parent)
{
    ...
    datatypeComboBox->addItem("每日时长占比");
