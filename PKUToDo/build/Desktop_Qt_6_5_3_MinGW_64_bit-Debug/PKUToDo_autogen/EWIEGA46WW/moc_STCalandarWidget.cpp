...
struct qt_meta_stringdata_CLASSSTCalandarWidgetENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSSTCalandarWidgetENDCLASS = QtMocHelpers::stringData(
    "STCalandarWidget",
    "DateSelectSignal",
    "",
    "date",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSSTCalandarWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSSTCalandarWidgetENDCLASS_t qt_meta_stringdata_CLASSSTCalandarWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 16),  // "STCalandarWidget"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSTCalandarWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject STCalandarWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSSTCalandarWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSTCalandarWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSTCalandarWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<STCalandarWidget, std::true_type>,
...
void STCalandarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &STCalandarWidget::DateSelectSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *STCalandarWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSTCalandarWidgetENDCLASS.stringdata0))
