...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTasksPieChartENDCLASS_t qt_meta_stringdata_CLASSTasksPieChartENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 18),  // "onPieSeriesClicked"
        QT_MOC_LITERAL(33, 0),  // ""
        QT_MOC_LITERAL(34, 10),  // "QPieSlice*"
        QT_MOC_LITERAL(45, 5)   // "slice"
    },
    "TasksPieChart",
    "onPieSeriesClicked",
    "",
...
void TasksPieChart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TasksPieChart *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->onPieSeriesClicked((*reinterpret_cast< std::add_pointer_t<QPieSlice*>>(_a[1]))); break;
        default: ;
        }
